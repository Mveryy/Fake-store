...
export default function Modal() {
  ...
  return (
    <div className="max-w-[500px] text-black bg-white rounded-md px-6 py-8 relative flex flex-col justify-between items-center text-center gap-6 z-30 sm:max-w-[80%] nav:max-w-[80%] my-32">
      <div className="w-full h-52 rounded-t-md flex items-center justify-center sm:h-24 nav:h-24">
        <img className="h-48 sm:h-24 nav:h-24" src={image} />
      </div>
      ...
      <p className="sm:text-sm nav:text-sm">{description.slice(0, 200) + "..."}</p>
